...
Write-Host "KYC Service:         http://localhost:8081/swagger/index.html"
Write-Host "Investment Service:  http://localhost:8082/swagger/index.html"
Write-Host "User Service:        http://localhost:8083/swagger/index.html"
