...
resource "aws_security_group" "node" {
  ...
  description = "Security group for EKS node group ${local.cluster_name}"
  vpc_id      = var.vpc_id
...
# Allow pods running extension API servers on port 443 to receive communication from the cluster control plane
